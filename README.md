...
![IVGG8](https://github.com/Ruiwen-HE/Cow-heat-state-classification/blob/main/data/Vgg%20and%20inception.png)
Fig 1. Design of our CNN model: from VGG16 to InceptionVGG8 (first published in [1]).
